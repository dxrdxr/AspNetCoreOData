...
{
    public class OpenComplexTypeTests
    {
        [Fact]
        public async Task OpenComplexType_SimpleSerialization()
        {
            // Arrange
        ...
        public async Task OpenComplexType_PatchComplexTypeDynamicProperty()
        {
            string payload = @"{
                ...
                ""BirthDay"":""2016-01-29"",
                ""Telephone"":{
                    ""@odata.type"":""#Microsoft.AspNetCore.OData.Tests.Scenarios.Phone"",
        ...
        public async Task OpenComplexType_PatchComplexTypeDynamicProperty_Nested()
        {
            string payload = @"{
                ...
                ""BirthDay"":""2016-01-29"",
                ""Building"":{
                    ""@odata.type"":""#Microsoft.AspNetCore.OData.Tests.Scenarios.Building"",
    ...
    public class OpenCustomersController : ODataController
    {
        ...
        public IActionResult PostOpenCustomer([FromBody] OpenCustomer customer)
        {
        ...
        public IActionResult PutToAddress(int key, Delta<OpenAddress> address)
        {
            IList<OpenCustomer> customers = CreateCustomers();
            OpenCustomer customer = customers.FirstOrDefault(c => c.CustomerId == key);
            if (customer == null)
        ...
        public IActionResult PatchToAddress(int key, Delta<OpenAddress> address)
        {
            IList<OpenCustomer> customers = CreateCustomers();
            OpenCustomer customer = customers.FirstOrDefault(c => c.CustomerId == key);
            if (customer == null)
